 ...
 */
export const validDiagnosticsData = {
  testId: "767D629",
  employeeId: "891845",
 ...
 */
export const diagnosticsDataWithFailures = {
 ...
 */
export const invalidDataMissingFields = {
  testId: "767D631",
  employeeId: "891845",
 ...
 */
export const invalidDataInvalidIMEI = {
  ...validDiagnosticsData,
  testId: "767D632",
 ...
 */
export const invalidDataInvalidTimestamp = {
  ...validDiagnosticsData,
  testId: "767D633",
 ...
 */
export const invalidDataInvalidTestStructure = {
  ...validDiagnosticsData,
  testId: "767D634",
  screenTest: {
    status: true,
 ...
 */
export const exampleFetchRequest = async () => {
  try {
    const response = await fetch('http://localhost:3000/api/diagnose/upload-diag-data', {
      ...
      body: JSON.stringify(validDiagnosticsData)
    });
 ...
 * Example using axios
 */
export const exampleAxiosRequest = async () => {
  const axios = require('axios');
  
  try {
    const response = await axios.post(
      'http://localhost:3000/api/diagnose/upload-diag-data',
      validDiagnosticsData,
      {
        headers: {
          'Content-Type': 'application/json',
...
export const testAllScenarios = async () => {
  const scenarios = [
    { name: 'Valid data', data: validDiagnosticsData, shouldSucceed: true },
    { name: 'Data with failures', data: diagnosticsDataWithFailures, shouldSucceed: true },
    { name: 'Missing fields', data: invalidDataMissingFields, shouldSucceed: false },
    { name: 'Invalid IMEI', data: invalidDataInvalidIMEI, shouldSucceed: false },
    { name: 'Invalid timestamp', data: invalidDataInvalidTimestamp, shouldSucceed: false },
    { name: 'Invalid test structure', data: invalidDataInvalidTestStructure, shouldSucceed: false },
  ];
