...
router.post("/create-manual-diagnostics", async (req, res) => {
    try {
        ...
        const existingDiagnose = await prisma_1.prisma.manualDiagnosticsResult.findUnique({
        ...
        const diagnosticsResult = await prisma_1.prisma.manualDiagnosticsResult.create({
            data: {
                // id: diagnoseId.trim(),
