...
import { Search, MessageSquare, Bell, Menu, X, ChevronDown, ChevronRight } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between h-15 border-b border-gray-200 px-4">
          <img
        ...
        <div className="flex-1 overflow-y-auto py-4 h-[calc(100vh-140px)]">
          ...
          <div className="px-4 pb-4 mb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#296CFF] to-[#155DFC] flex items-center justify-center flex-shrink-0">
      ...
      <div className="hidden md:flex flex-1 max-w-md ml-12">
        <div 
          className="relative w-full cursor-pointer search-container"
        >
          <Search
          ...
          {showSearchDropdown && debouncedSearchTerm && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-[#E4E7EC] rounded-lg shadow-lg overflow-hidden z-50">
              ...
              >
                <div className="flex items-center gap-3">
                  <Search className="text-gray-400 group-hover:text-[#296CFF] transition-colors" size={18} />
                  <span className="text-gray-700 text-sm">
                    Search for <span className="font-semibold text-gray-900">"{debouncedSearchTerm}"</span>
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <ChevronRight className="text-gray-400 group-hover:text-[#296CFF] transition-colors" size={18} />
                </div>
              </div>
            </div>
          )}
