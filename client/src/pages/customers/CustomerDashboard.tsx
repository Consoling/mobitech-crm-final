...
const CustomerDashboard = () => {
  ...
  const fetchCustomers = useCallback(async (signal?: AbortSignal) => {
    ...
    try {
      const response = await apiJson<{ customers: CustomerApi[] }>(
  ...
  useEffect(() => {
    document.title = "Customers - Mobitech CRM";
                ...
                <TableRow key={customer.id}>
                  <TableCell className="px-5">
                    <Button
                      ...
                      onClick={() =>
                        navigate(`/clients/view-customer/${customer.id}`)
                      }
                    >
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-44 p-2" align="end">
                        <button
                          type="button"
                          onClick={() =>
                            navigate(`/clients/edit-customer/${customer.id}`)
                          }
